        ...
        <div className="p-4 border-b-2 border-primary/20">
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-2.5 pl-10 border-2 border-primary/30 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary transition bg-white text-primary font-medium shadow-md"
            />
            <svg
              className="absolute left-3 top-3.5 h-4 w-4 text-primary/50"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          {loading ? (
            ...
            filtered.map((s) => (
              <div
                ...
                className={`p-4 border-b border-primary/10 cursor-pointer transition ${
                  selected?.id === s.id
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs text-primary/70 truncate">{s.program || 'No program'}</div>
                  </div>
                </div>
              </div>
            ))
      ...
      <div className="flex-1 p-4 sm:p-6 overflow-auto bg-background">
        {!selected ? (
          <div className="text-center text-primary/60 pt-20">
            <svg
              className="h-12 w-12 mx-auto mb-4 text-primary/40"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-primary/70">{selected.email}</p>
            </div>
              ...
              <nav className="flex space-x-8">
                {tabs.map((tab) => (
                  <button
                    ...
                    className={`py-4 px-1 border-b-2 font-extrabold text-sm transition ${
                      activeTab === tab.id
                ...
                <Card>
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <div>
                        <span className="text-sm font-semibold text-primary/70">Student:</span>
                ...
                <Card>
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <p className="text-primary/70 text-sm">Payment history will be displayed here.</p>
                    </div>
                  </div>
                </Card>
              )}
              ...
              {activeTab === 'progress' && (
                <Card>
                  <div className="space-y-4">
                    ...
                    <p className="text-primary/70">Progress reports and analytics will be displayed here.</p>
                  </div>
                </Card>
              )}
              ...
              {activeTab === 'communication' && (
                <Card>
                  <div className="space-y-4">
                    ...
                    <p className="text-primary/70">Communication history and messages will be displayed here.</p>
                  </div>
                </Card>
              )}
            </div>
