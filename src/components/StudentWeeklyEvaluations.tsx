...
interface StudentWeeklyEvaluationsProps {
  studentId: string;
  studentName: string;
  onClose: () => void;
}

const StudentWeeklyEvaluations: React.FC<StudentWeeklyEvaluationsProps> = ({
  studentId,
  studentName,
  onClose
}) => {
  ...
  const loadEvaluations = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_BASE}/students/${studentId}/weekly-evaluations`, {
        headers: {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 overflow-y-auto">
      <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] flex flex-col">
        ...
        <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex justify-between items-center rounded-t-lg">
          <div>
            <h2 className="text-xl font-semibold text-gray-900">Weekly Evaluations</h2>
        ...
        <div className="flex-1 overflow-y-auto p-6">
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-sm text-gray-500 mt-1">This student has no weekly evaluations yet.</p>
            </div>
          ) : (
                ...
                <Card key={evaluation.id || evaluation._id} className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                      ...
                      evaluation.status === 'feedback_provided' ? 'bg-yellow-100 text-yellow-800' :
