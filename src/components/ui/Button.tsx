...
const Button: React.FC<ButtonProps> = React.memo(({
  ...
  const variantClasses = {
    ...
    secondary: 'bg-accent text-white hover:bg-accent/90 focus:ring-accent shadow-md hover:shadow-lg',
    outline: 'border-2 border-primary/30 text-primary hover:bg-soft-primary hover:border-primary focus:ring-primary',
