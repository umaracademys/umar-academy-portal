...
const ModernAssignmentForm: React.FC<ModernAssignmentFormProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 px-4 py-6 overflow-y-auto">
      <div className="flex w-full max-w-[1200px] max-h-[90vh] my-auto flex-col overflow-hidden rounded-3xl bg-white shadow-2xl">
        ...
        <div className="flex flex-1 min-h-0 flex-col lg:flex-row overflow-hidden">
          <aside className="w-full border-b border-gray-100 bg-gray-50/80 p-6 lg:w-[320px] lg:border-r lg:border-b-0 overflow-y-auto flex-shrink-0">
          ...
          <main className="flex-1 overflow-y-auto bg-white p-6 lg:p-8 min-h-0 flex-shrink">
